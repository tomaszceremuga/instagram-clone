...
const NotificationsView = (props: Props) => {
    ...
    const seeNotification = async (notificationId: number, url: string) => {
        try {
    ...
    return (
        <div className={cn("w-full h-full  md:p-6 ", props.className)}>
            ...
            {notifications.length === 0 ? (
                <div className="flex items-center justify-center gap-3 flex-col min-w-0 h-3/4 p-6 text-center">
                    <svg
                    ...
                    <p className="text-2xl font-semibold">There are no notifiacions</p>
                    <p className="text-gray-500">
                        When someone follows you, like or comment your post, you'll see it here.
                    </p>
                </div>
            ) : (
                <div
